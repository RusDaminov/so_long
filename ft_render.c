...
int	ft_open_collect(t_game *game)
{
	...
	game->collect_img = mlx_xpm_file_to_image(game->mlx,
										   "./img/btc1.xpm", &iw, &ih);
	game->collect2_img = mlx_xpm_file_to_image(game->mlx,
											  "./img/btc2.xpm", &iw, &ih);
	if (!(game->collect_img) || !(game->collect2_img))
		return (-1);
	return (0);
}
...
int	ft_open_player(t_game *game)
{
	...
	game->player_u_img = mlx_xpm_file_to_image(game->mlx,
											"./img/up.xpm", &iw, &ih);
	game->player_d_img = mlx_xpm_file_to_image(game->mlx,
											  "./img/down.xpm", &iw, &ih);
	game->player_l_img = mlx_xpm_file_to_image(game->mlx,
											  "./img/left.xpm", &iw, &ih);
	game->player_r_img = mlx_xpm_file_to_image(game->mlx,
											   "./img/right.xpm", &iw, &ih);
	if (!(game->player_u_img) || !(game->player_d_img)
		|| !(game->player_l_img) || !(game->player_r_img))
		return (-1);
	return (0);
}
